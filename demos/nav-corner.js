...
exports.Vector3 = exports.Vector2 = exports.Polygon = exports.Segment = exports.Intersection = exports.Vertex = exports.Point = undefined;
...
var Vertex = exports.Vertex = function (_Point) {
  _inherits(Vertex, _Point);
   ...
   */
  function Vertex(x, y) {
    var segOut = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var segIn = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
     ...
     */
    var _this = _possibleConstructorReturn(this, (Vertex.__proto__ || Object.getPrototypeOf(Vertex)).call(this, x, y));
...
var Intersection = exports.Intersection = function (_Point2) {
  _inherits(Intersection, _Point2);
  ...
  function Intersection(x, y) {
    var segA = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var segB = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
     ...
     */
    var _this2 = _possibleConstructorReturn(this, (Intersection.__proto__ || Object.getPrototypeOf(Intersection)).call(this, x, y));
...
var Segment = exports.Segment = function () {
  ...
  _createClass(Segment, [{
    ...
    key: 'left',
    value: function left(point) {
      var va = Vector2.fromPoints(point, this.vtxA);
      var vb = Vector2.fromPoints(point, this.vtxB);
    ...
    key: 'intersect',
    value: function intersect(seg) {
      var segA = this;
      var segB = seg;

      var r_px = segA.vtxA.x;
      var r_py = segA.vtxA.y;
      var r_dx = segA.vtxB.x - segA.vtxA.x;
      var r_dy = segA.vtxB.y - segA.vtxA.y;

      var s_px = segB.vtxA.x;
      var s_py = segB.vtxA.y;
      var s_dx = segB.vtxB.x - segB.vtxA.x;
      var s_dy = segB.vtxB.y - segB.vtxA.y;

      var H = s_dx * r_dy - r_dx * s_dy;

      if (H === 0) return null;

      var Hrt = s_dx * (s_py - r_py) - s_dy * (s_px - r_px);
      var Hst = r_dx * (s_py - r_py) - r_dy * (s_px - r_px);
...
var Polygon = exports.Polygon = function () {
  ...
  function Polygon(points) {
    ...
    this.vtxs.forEach(function (vertex, index, arr) {
      var nextVertex = arr[(index + 1) % arr.length];
      var prevVertex = arr[(index - 1 + arr.length) % arr.length];
  ...
  _createClass(Polygon, [{
    key: 'segOnEdge',
    value: function segOnEdge(seg) {
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;

      try {
        for (var _iterator2 = this.vtxs[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var vtx = _step2.value;
    ...
    value: function pointInside(point) {
      ...
      var ray = new Segment(point, point.offset(new Point(-10000, 0)));
      var interPoints = [];
      ...
      try {
        for (var _iterator3 = this.vtxs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var vtx = _step3.value;

          var seg = vtx.segOut;
          var inter = ray.intersect(seg);
      ...
      interPoints = _lodash2.default.uniq(interPoints, function (point) {
    ...
    value: function segInside(seg) {
      ...
      try {
        for (var _iterator4 = this.vtxs[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var vtx = _step4.value;

          var inter = vtx.segOut.intersect(seg);
          if (inter) {
            return false;
          }
        }
      ...
      var centerX = (seg.vtxA.x + seg.vtxB.x) / 2;
      var centerY = (seg.vtxA.y + seg.vtxB.y) / 2;
    ...
    value: function clone() {
      ...
      try {
        for (var _iterator5 = this.vtxs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    value: function offset(x, y) {
      ...
      try {
        for (var _iterator6 = this.vtxs[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
var Vector2 = exports.Vector2 = function () {
  _createClass(Vector2, null, [{
     ...
     * @return {Vector2}
     */
    value: function fromPoints(pointA, pointB) {
  ...
  _createClass(Vector2, [{
    ...
    key: 'radians',
    value: function radians(vec) {
      var dot = this.dot(vec);
      var cosVal = dot / this.distance() / vec.distance();
...
var _ViewField = __webpack_require__(2);

Object.keys(_ViewField).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _ViewField[key];
    }
  });
});
...
Object.keys(_painter).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
 ...
 * @deprecated
 */
var ViewField = exports.ViewField = function () {
  _createClass(ViewField, null, [{
    key: 'fromVecs',
     ...
     * @return {ViewField}
     */
    value: function fromVecs(vecA, vecB) {
      var origin = new _geometry.Point(0, 0);
      var pointA = new _geometry.Point(vecA.x, vecA.y);
      var pointB = new _geometry.Point(vecB.x, vecB.y);
  ...
  function ViewField(origin, pointA, pointB) {
     ...
     * @type {Vector2} vecA
     */
    this.vecA = _geometry.Vector2.fromPoints(origin, pointA);

    /**
     * end vector
     * @type {Vector2} vecB
     */
    this.vecB = _geometry.Vector2.fromPoints(origin, pointB);
  ...
  _createClass(ViewField, [{
    key: 'bisector',
    value: function bisector() {
      var nvecA = this.vecA.normalize();
      var nvecB = this.vecB.normalize();
    ...
    key: 'left',
    value: function left(vf) {
      var bisA = this.bisector();
      var bisB = vf.bisector();
...
var Painter = exports.Painter = function () {
  ...
  _createClass(Painter, [{
    ...
    key: 'paintSeg',
    value: function paintSeg(seg) {
      var context = this.context;
      var pointA = this._convCoord(seg.vtxA);
      var pointB = this._convCoord(seg.vtxB);
      context.save();
      context.beginPath();
    ...
    key: 'paintPolygon',
    value: function paintPolygon(poly) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = poly.vtxs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var vtx = _step.value;
    ...
    value: function getCursor() {
      return new _geometry.Point(this.x, this.y);
    }
    ...
    key: '_convCoord',
    value: function _convCoord(point) {
      return new _geometry.Point(point.x, this.height - point.y);
    }
    ...
    key: '_parseCursor',
    value: function _parseCursor(x, y) {
    ...
    value: function _enableCursor() {
      ...
      canvas.addEventListener("mousemove", function (e) {
        ...
        _this.x = x - bbox.left * (canvas.width / bbox.width) || 0;
        y = y - bbox.top * (canvas.height / bbox.height) || 0;
        _this.y = _this.height - y;
      }, false);
    }
  }]);
...
var painter = new _geometry.Painter('painter', 250, 250);

// create first square
/**
 * @author yewmint
 */
var pa = new _geometry.Polygon([new _geometry.Point(50, 50), new _geometry.Point(100, 50), new _geometry.Point(100, 100), new _geometry.Point(50, 100)]);

// create other squares with offset
var pb = pa.offset(50, 0);
var pc = pb.offset(50, 0);
var pd = pc.offset(0, 50);
var pe = pd.offset(0, 50);
...
var edges = [pa.vtxs[1].segOut, pb.vtxs[1].segOut, pc.vtxs[2].segOut, pd.vtxs[2].segOut];
...
try {
  for (var _iterator = edges[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var _seg2 = _step.value;

    painter.paintSeg(_seg2);
  }
...
var startPoint = new _geometry.Point(75, 75);
var endPoint = new _geometry.Point(175, 175);
 ...
 */
var getConer = function getConer(startpt, segs, endpt) {
  // no corner point if startpt and endpt are in convex polygon
  if (segs.length <= 0) return null;

  var oapt = segs[0].vtxA;
  var obpt = segs[0].vtxB;
  var idx = 0;

  // if there are 2 segments at least, find the overlapped field of view
  while (++idx < segs.length) {
    var _vecoa = _geometry.Vector2.fromPoints(startpt, oapt);
    var _vecob = _geometry.Vector2.fromPoints(startpt, obpt);
    var vecea = _geometry.Vector2.fromPoints(startpt, segs[idx].vtxA);
    var veceb = _geometry.Vector2.fromPoints(startpt, segs[idx].vtxB);

    if (_vecoa.acuteAngle(vecea)) {
      if (_vecob.acuteAngle(vecea)) {
        return {
          pt: obpt,
          segs: segs.slice(idx)
        };
      } else if (_vecob.acuteAngle(veceb)) {
        oapt = segs[idx].vtxA;
      } else {
        oapt = segs[idx].vtxA;
        obpt = segs[idx].vtxB;
      }
    } else if (_vecoa.acuteAngle(veceb)) {
      if (_vecob.acuteAngle(veceb)) {} else {
        obpt = segs[idx].vtxB;
      }
    } else {
      return {
  ...
  var vece = _geometry.Vector2.fromPoints(startpt, endpt);
  var vecoa = _geometry.Vector2.fromPoints(startpt, oapt);
  var vecob = _geometry.Vector2.fromPoints(startpt, obpt);
...
window.nav = function () {
  ...
  try {
    for (var _iterator2 = corners[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      var _seg = new _geometry.Segment(pspt, corner);
      painter.paintSeg(_seg);
      pspt = corner;
    }
  } catch (err) {
    _didIteratorError2 = true;
  ...
  var seg = new _geometry.Segment(pspt, endpt);
...
/***/ })
/******/ ]);
//# sourceMappingURL=nav-corner.js.map